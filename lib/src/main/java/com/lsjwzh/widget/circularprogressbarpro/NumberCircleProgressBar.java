package com.lsjwzh.widget.circularprogressbarpro;
...
public class NumberCircleProgressBar extends View {
    ...
    /**
     * the Stroke width  when FillMode is ring
     */
    ...
    public NumberCircleProgressBar(Context context, AttributeSet attrs) {
        this(context, attrs, R.attr.numberCircleProgressBarStyle);
    }
    ...
    public NumberCircleProgressBar(Context context, AttributeSet attrs,
        ...
        try {
            mFillMode = attributes.getInt(
                    R.styleable.NumberCircleProgressBar_ncpb_progress_fill_mode,
                    DEFAULT_FILL_MODE);
            mCircleRadius = attributes.getDimension(
                    R.styleable.NumberCircleProgressBar_ncpb_progress_circle_radius,
                    DEFAULT_CIRCLE_RADIUS);
            mStrokeWidth = attributes.getDimension(
                    R.styleable.NumberCircleProgressBar_ncpb_progress_stroke_width,
                    DEFAULT_STROKE_WIDTH);

            mReachedBarColor = attributes.getColor(
                    R.styleable.NumberCircleProgressBar_ncpb_progress_reached_color,
                    DEFAULT_REACHED_COLOR);
            mUnreachedBarColor = attributes
                    .getColor(
                            R.styleable.NumberCircleProgressBar_ncpb_progress_unreached_color,
                            DEFAULT_UNREACHED_COLOR);
            mTextColor = attributes.getColor(
                    R.styleable.NumberCircleProgressBar_ncpb_progress_text_color,
                    DEFAULT_TEXT_COLOR);
            mTextSize = attributes.getDimension(
                    R.styleable.NumberCircleProgressBar_ncpb_progress_text_size,
                    DEFAULT_TEXT_SIZE);

            int textVisible = attributes
                    .getInt(R.styleable.NumberCircleProgressBar_ncpb_progress_text_visibility,
            ...
            setProgress(attributes.getInt(
                    R.styleable.NumberCircleProgressBar_ncpb_progress, 0));
            setMax(attributes.getInt(R.styleable.NumberCircleProgressBar_ncpb_max,
                    100));
        } finally {
            attributes.recycle();
        }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if(mFillMode==2){
            ...
            mSectorPaint.setStrokeWidth(mStrokeWidth);
        }else {
